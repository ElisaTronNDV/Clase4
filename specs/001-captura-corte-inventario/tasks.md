...
- [ ] T035 [P] [US2] Crear modelo `Producto` en `backend/app/models/producto.py` —
...
- [ ] T045 [US2] Implementar `POST /api/ordenes/extraer-pdf` en `backend/app/api/ordenes.py`
...
- [ ] T049 [P] [US2] Implementar `frontend/src/app/oficina/subir-pdf/subir-pdf.component.ts` —
