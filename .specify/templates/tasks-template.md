...
**Tests**: Per the project constitution (Test-First, NON-NEGOTIABLE), test tasks are MANDATORY for every user story — write them first and confirm they fail before implementing.
